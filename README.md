...
Проект реализует сервис авторизации пользователей по номеру телефона с подтверждением по SMS, 
систему инвайт-кодов и профиль пользователя.
...
```bash
git clone https://github.com/svetlana-kolesnikova/Auth_service
cd Auth_service
```
